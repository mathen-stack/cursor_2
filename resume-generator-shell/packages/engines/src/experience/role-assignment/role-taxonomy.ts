...
export const ROLE_DEFINITIONS: readonly RoleDefinition[] = [
  ...
  {
    family: "mobile-engineering",
    baseRole: "Mobile Engineer",
    explicitPatterns: [
    ...
    signals: [
      { phrase: "mobile engineering", weight: 8 },
      { phrase: "react native", weight: 7 },
      { phrase: "swift", weight: 5 },
      { phrase: "kotlin", weight: 5 },
      { phrase: "flutter", weight: 6 },
      { phrase: "ios", weight: 3 },
      { phrase: "android", weight: 3 },
    ],
    progression: {
      foundational: "Software Engineer",
      practitioner: "Mobile Engineer",
      senior: "Senior Mobile Engineer",
    },
  },
  {
    family: "qa-engineering",
    baseRole: "QA Engineer",
    explicitPatterns: [
      /\bqa engineer\b/i,
  ...
  },
  {
    ...
    explicitPatterns: [
      /\bdatabase engineer\b/i,
      /\bdatabase administrator\b/i,
      /\bdata platform engineer\b/i,
    ],
    signals: [
      { phrase: "database engineering", weight: 8 },
      ...
      { phrase: "mysql", weight: 3 },
    ],
    progression: {
      foundational: "Database Analyst",
      practitioner: "Database Engineer",
      senior: "Senior Database Engineer",
    },
  },
  {
    family: "embedded-engineering",
    baseRole: "Embedded Systems Engineer",
    explicitPatterns: [
      /\bembedded (?:systems )?engineer\b/i,
    ...
    progression: {
      foundational: "Firmware Engineer",
      practitioner: "Embedded Systems Engineer",
      senior: "Senior Embedded Systems Engineer",
    },
  },
  {
    family: "blockchain-engineering",
    baseRole: "Blockchain Engineer",
    explicitPatterns: [
      /\bblockchain engineer\b/i,
      /\bsmart contract engineer\b/i,
      /\bweb3 engineer\b/i,
    ],
    signals: [
      { phrase: "blockchain", weight: 8 },
      { phrase: "smart contract", weight: 7 },
      { phrase: "solidity", weight: 7 },
      { phrase: "ethereum", weight: 5 },
      { phrase: "web3", weight: 5 },
      { phrase: "defi", weight: 4 },
    ],
    progression: {
      foundational: "Software Engineer",
      practitioner: "Blockchain Engineer",
      senior: "Senior Blockchain Engineer",
    },
  },
  {
